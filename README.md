...
- deegree 3.6 (JDK 17/Tomcat 10.1): `3.6.4`, `3.6`, `latest` (deprecated tags: `3.6.3`, `3.6.2`, `3.6.1`, `3.6.0`) - [Dockerfile](https://github.com/deegree/deegree3-docker/blob/main/3.6/Dockerfile)
